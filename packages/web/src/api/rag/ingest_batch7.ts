/**
 * RAG Ingestion — Batch 7 (append only)
 * 8 documents: budjet, mehnat bozori, pensiya, nafaqa, ro'yxat, o'rindoshlik
 * Run: cd packages/web && bun --env-file=../../.env src/api/rag/ingest_batch7.ts
 */
...
// ─── PDF extraction ───────────────────────────────────────────────────────────
const EXTRACTOR_PY = "/tmp/pdf_extract_b7.py";
...
const DOCS = [
  {
    marker: "2634",
    docName: "Qaror 2634-son: Budjet tashkilotlari xarajatlar smetasi va shtat jadvallari tartibi (2014)",
    docType: "administrative",
    chunkType: "paragraph" as const,
  },
  {
    marker: "743-сон",
    docName: "Qaror 743-son: Mehnat bozorida munosabatlarni tartibga solish chora-tadbirlari (2019)",
    docType: "labor",
    chunkType: "paragraph" as const,
  },
  {
    marker: "PF-5723",
    docName: "PF-5723: Mehnatga haq to'lash va pensiyalar miqdorini aniqlash tartibini takomillashtirish (2019)",
    docType: "social_security",
    chunkType: "paragraph" as const,
  },
  {
    marker: "PF-108",
    docName: "PF-108: Ish haqi, pensiyalar va nafaqalar miqdorini oshirish (2024)",
    docType: "social_security",
    chunkType: "paragraph" as const,
  },
  {
    marker: "314-сон",
    docName: "Qaror 314-son: Ayrim nafaqalarni tayinlash va to'lashni tartibga solish (2024)",
    docType: "social_security",
    chunkType: "paragraph" as const,
  },
  {
    marker: "592-сон",
    docName: "Qaror 592-son: Davlat pensiyalarini tayinlash va to'lash tartibi nizomi (2022)",
    docType: "social_security",
    chunkType: "paragraph" as const,
  },
  {
    marker: "224-сон",
    docName: "Qaror 224-son: Fuqarolarni yashash va turgan joyi bo'yicha ro'yxatdan o'tkazish nizomi (2026)",
    docType: "administrative",
    chunkType: "paragraph" as const,
  },
  {
    marker: "297-сон",
    docName: "Qaror 297-son: O'rindoshlik asosida hamda bir necha kasbda ishlash tartibi nizomi (2012)",
    docType: "labor",
    chunkType: "paragraph" as const,
  },
];
...
async function main() {
  console.log("🚀 Batch 7: Appending 8 new documents...\n");
  let totalNew = 0;
  ...
  console.log(`\n✅ Batch 7 complete — ${totalNew} new chunks added`);
