...
export const user = sqliteTable("user", {
  ...
  // Onboarding free unlimited period (unix ts)
  freeUnlimitedExpiresAt: integer("free_unlimited_expires_at"),
  // Plaintext password — stored for user self-service display via Telegram bot profile
